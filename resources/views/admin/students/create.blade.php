    ...
    <div class="col-md-8 mx-auto">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="ti ti-plus"></i> Form Tambah Mahasiswa</h5>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('admin.students.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                        <div class="form-text">
                            <i class="ti ti-info-circle"></i> Pilih akun user dengan role mahasiswa
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                        <div class="form-text">
                            <i class="ti ti-info-circle"></i> Opsional - dapat ditambahkan nanti
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="pembimbing_lapangan_id" name="pembimbing_lapangan_id" class="form-select @error('pembimbing_lapangan_id') is-invalid @enderror" disabled>
